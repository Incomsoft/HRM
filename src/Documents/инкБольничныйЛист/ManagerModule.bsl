...
// Функция - Сформировать больничный лист результат расчета табличный документ
//
// Параметры:
//  БольничныйЛистОбъект - Объект - Документ объект "Больничный лист"
// 
// Возвращаемое значение:
//   ТабличныйДокумент - Больничный лист для печати
//
