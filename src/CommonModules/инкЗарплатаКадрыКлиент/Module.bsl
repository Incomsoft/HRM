...
// Процедура - Ввод месяца при изменении
//
// Параметры:
//  РедактируемыйОбъект			 - Объект	 - Объект (источник данных);
//  ПутьРеквизита				 - Строка	 - Путь реквезита;
//  ПутьРеквизитаПредставления	 - Строка	 - Путь реквизита представления;
//  Модифицированность			 - Бушев	 - Признак модифицирования;
//
...
// Процедура - Ввод месяца регулирование
//
// Параметры:
//  РедактируемыйОбъект			 - Объект	 - 
//  ПутьРеквизита				 - Строка	 - 
//  ПутьРеквизитаПредставления	 - Строка	 - 
//  Направление					 - Число	 - 
//  Модифицированность			 - Булево	 - 
//  ЗначениеМесяцаПоУмолчанию	 - Дата		 - 
//
...
// Функция - Дата как месяц подобрать дату по тексту
//
// Параметры:
//  Текст		 - Строка	- Текст;
//  ДатаПоТексту - Дата	 	- Дата по тексту;
// 
// Возвращаемое значение:
//   - Список значений;
//
