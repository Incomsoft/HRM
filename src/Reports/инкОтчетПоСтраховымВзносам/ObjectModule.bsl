...
Перем Организация Экспорт; 		// Ссылка - Ссылка на справочник "Огранизации"
Перем ПериодКвартала Экспорт;	// СтандартныйПериод - Период квартал
...
//  Структура - Табличные документы для отчета
//
