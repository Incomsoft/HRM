...
Функция ЗначениеСвойстваJSON(ЧтениеОтвета, ТекущийУровень, ЗначениеПоУмолчанию = Неопределено) Экспорт
...
Функция ЧтениеJSONПрочитать(Чтение, ТекущийУровень) Экспорт 
...
Процедура ИнформацияОДоступномОбновленииВызовОперации(
	...
	// +++ Чесноков М.С. 2023-01-17 здч0033
	...
	URLОперации = "http://localhost/IncomsoftCRM/hs/update/info";
	//URLОперации = "http://srv1c.ddns.net/inccrmapi/hs/update/info";
	// --- Чесноков М.С. 2023-01-17 здч0033
	...
	// +++ Чесноков М.С. 2023-01-17 здч0033
	ПараметрыОперации.Вставить("УИДРегистрации", инкОбщийСервер.ПолучитьУИДРегистрации());
	ПараметрыОперации.Вставить("УИДПрограммы", инкОбщийСервер.ПолучитьУИДПрограммы());
	// --- Чесноков М.С. 2023-01-17 здч0033
...
Функция InfoRequestJSON(ПараметрыОперации, ДопПараметрыЗапроса)
	...
	ЗаписьДанныхСообщения.ЗаписатьЗначение(ПараметрыОперации.УИДРегистрации);
	ЗаписьДанныхСообщения.ЗаписатьИмяСвойства("UIDProg");
	ЗаписьДанныхСообщения.ЗаписатьЗначение(ПараметрыОперации.УИДПрограммы);  
	// --- Чесноков М.С. 2023-01-17 здч0033
