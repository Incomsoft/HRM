...
Процедура ЗагрузитьНастройки_КонфигурацияВыплатВФонды()
	...
	Запрос.Текст = 
		...
		|	инкКонфигурацияВыплатВФондыСрезПоследних.СФР КАК СФР
		|ИЗ
	...
	ДобавитьСтрокуВТаблицу_КонфигурацияВыплатВФонды(Перечисления.инкСтрокаТарифаВЗН.ТарифСвышеМРОТ_1_5_ДляМСБ,РезультатЗапросаТаблица);
