...
&НаКлиенте
Процедура мОтчетПоОстаткуОтпусковПриАктивизации(Элемент)
...
Процедура РассчитатьПоказателиДинамическиОтчетПоОстаткуОтпусков() 
	...
	инкОтчетыКлиент.РассчитатьПоказатели(ЭтотОбъект, "мОтчетПоОстаткуОтпусков");
...
Процедура СформироватьОтчетНаСервере(ПараметрыВЗапросе)
	...
	мОтчетПоОстаткуОтпусков = ТабличныеДокументыСтруктура.ОтчетПоОстаткуОтпусков;
...
Процедура УстановитьНастройкиТабличныхДокументов()
	...
	УстановитьНастройкиТабличногоДокумента(мОтчетПоОстаткуОтпусков);
