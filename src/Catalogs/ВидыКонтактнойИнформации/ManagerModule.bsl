...
Процедура Обновление_11_0_2_41() Экспорт

	ВидКонтактнойИнформации = Справочники.ВидыКонтактнойИнформации.Slack.ПолучитьОбъект();
	ВидКонтактнойИнформации.Используется = Истина;
	ВидКонтактнойИнформации.Тип = Перечисления.ТипыКонтактнойИнформации.Другое;
	ВидКонтактнойИнформации.Записать();
	
	ВидКонтактнойИнформации = Справочники.ВидыКонтактнойИнформации.VKontakte.ПолучитьОбъект();
	ВидКонтактнойИнформации.Используется = Истина;
	ВидКонтактнойИнформации.Тип = Перечисления.ТипыКонтактнойИнформации.Другое;
	ВидКонтактнойИнформации.Записать();
...
Процедура Обновление_11_0_2_28() Экспорт
	
	ВидКонтактнойИнформации = Справочники.ВидыКонтактнойИнформации.АдресЭлектроннойПочтыСотрудника.ПолучитьОбъект();
	ВидКонтактнойИнформации.Используется = Истина;
	ВидКонтактнойИнформации.Тип = Перечисления.ТипыКонтактнойИнформации.АдресЭлектроннойПочты;
	ВидКонтактнойИнформации.Записать();
	
	ВидКонтактнойИнформации = Справочники.ВидыКонтактнойИнформации.СкайпСотрудника.ПолучитьОбъект();
	ВидКонтактнойИнформации.Используется = Истина;
	ВидКонтактнойИнформации.Тип = Перечисления.ТипыКонтактнойИнформации.Skype;
	ВидКонтактнойИнформации.Записать();

	ВидКонтактнойИнформации = Справочники.ВидыКонтактнойИнформации.ТелеграммСотрудника.ПолучитьОбъект();
	ВидКонтактнойИнформации.Используется = Истина;
	ВидКонтактнойИнформации.Тип = Перечисления.ТипыКонтактнойИнформации.Другое;
	ВидКонтактнойИнформации.Записать();
	
	ВидКонтактнойИнформации = Справочники.ВидыКонтактнойИнформации.ТелефонСотрудника.ПолучитьОбъект();
	ВидКонтактнойИнформации.Используется = Истина;
	ВидКонтактнойИнформации.Тип = Перечисления.ТипыКонтактнойИнформации.Телефон;
	ВидКонтактнойИнформации.Записать();

КонецПроцедуры

// Обработчик обновления УТ 11.0.0.9
Процедура ОбновлениеСправочника_11_0_0_9() Экспорт
	
	// Организация (контактный телефон):
	РегистрацияОбъект = Справочники.ВидыКонтактнойИнформации.КонтактныйТелефонОрганизации.ПолучитьОбъект();
	РегистрацияОбъект.Используется = Истина;
	РегистрацияОбъект.Тип = Перечисления.ТипыКонтактнойИнформации.Телефон;
	РегистрацияОбъект.Записать();
	
КонецПроцедуры

// Обработчик обновления УТ 11.0.0.8
Процедура ОбновлениеСправочника_11_0_0_8() Экспорт
	
	// Для групп:
	МестоЖительстваРегистрацияОбъект = Справочники.ВидыКонтактнойИнформации.СправочникинкСотрудники.ПолучитьОбъект();
	МестоЖительстваРегистрацияОбъект.Используется = Истина;
	МестоЖительстваРегистрацияОбъект.Записать();
	
	МестоЖительстваРегистрацияОбъект = Справочники.ВидыКонтактнойИнформации.СправочникПользователи.ПолучитьОбъект();
	МестоЖительстваРегистрацияОбъект.Используется = Истина;
	МестоЖительстваРегистрацияОбъект.Записать();
	
	МестоЖительстваРегистрацияОбъект = Справочники.ВидыКонтактнойИнформации.СправочникинкОрганизации.ПолучитьОбъект();
	МестоЖительстваРегистрацияОбъект.Используется = Истина;
	МестоЖительстваРегистрацияОбъект.Записать();
	
	// Для элементов:                                                                              
	//		Пользователи:
	МестоЖительстваРегистрацияОбъект = Справочники.ВидыКонтактнойИнформации.EmailПользователя.ПолучитьОбъект();
	МестоЖительстваРегистрацияОбъект.Используется = Истина;
	МестоЖительстваРегистрацияОбъект.Тип = Перечисления.ТипыКонтактнойИнформации.АдресЭлектроннойПочты;
	МестоЖительстваРегистрацияОбъект.Записать();
	
	МестоЖительстваРегистрацияОбъект = Справочники.ВидыКонтактнойИнформации.ТелефонПользователя.ПолучитьОбъект();
	МестоЖительстваРегистрацияОбъект.Используется = Истина;
	МестоЖительстваРегистрацияОбъект.Тип = Перечисления.ТипыКонтактнойИнформации.Телефон;
	МестоЖительстваРегистрацияОбъект.Записать();
	
	// 		Организация:
	РегистрацияОбъект = Справочники.ВидыКонтактнойИнформации.ФактическийАдресОрганизации.ПолучитьОбъект();
	РегистрацияОбъект.Используется = Истина;
	РегистрацияОбъект.Тип = Перечисления.ТипыКонтактнойИнформации.Адрес;
	РегистрацияОбъект.Записать();
	
	РегистрацияОбъект = Справочники.ВидыКонтактнойИнформации.ЮридическийАдресОрганизации.ПолучитьОбъект();
	РегистрацияОбъект.Используется = Истина;
	РегистрацияОбъект.Тип = Перечисления.ТипыКонтактнойИнформации.Адрес;
	РегистрацияОбъект.Записать();
...
// Обработчик обновления УТ 11.0.0.7
Процедура ОбновлениеСправочника_11_0_0_7() Экспорт
	
	МестоЖительстваРегистрацияОбъект = Справочники.ВидыКонтактнойИнформации.МестоЖительстваРегистрация.ПолучитьОбъект();
	МестоЖительстваРегистрацияОбъект.Используется = Истина;
	МестоЖительстваРегистрацияОбъект.Тип = Перечисления.ТипыКонтактнойИнформации.Адрес;
	МестоЖительстваРегистрацияОбъект.Записать();
	
	МестоЖительстваРегистрацияОбъект = Справочники.ВидыКонтактнойИнформации.МестоЖительстваФактически.ПолучитьОбъект();
	МестоЖительстваРегистрацияОбъект.Используется = Истина;
	МестоЖительстваРегистрацияОбъект.Тип = Перечисления.ТипыКонтактнойИнформации.Адрес;
	МестоЖительстваРегистрацияОбъект.Записать();
