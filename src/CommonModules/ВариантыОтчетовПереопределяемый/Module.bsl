...
Процедура ОпределитьРазделыСВариантамиОтчетов(Разделы) Экспорт
	...
	// +++ Чесноков М.С. 2023-03-09 *№ 0000004
	Разделы.Добавить(Метаданные.Подсистемы.инкОтчеты);
	// --- Чесноков М.С. 2023-03-09 *№ 0000004
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	// +++ Чесноков М.С. 2023-03-09 *№ 0000004
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.инкДниРожденияСотрудников);
	// --- Чесноков М.С. 2023-03-09 *№ 0000004
