...
Перем Организация Экспорт; // Организация справочник ссылка;
...
//  ТабличныйДокумент -  Справка 1-НДФЛ;
//
...
Функция Получить1НДФЛНаСервере()
	...
	ВычетыЗаИсключениемСтандартныхТаблица 	= Получить_ВычетыЗаИсключениемСтандартных(Сотрудники);
	СтандартныеНалоговыеВычетыТаблица 		= Получить_СтандартныеНалоговыеВычеты(Сотрудники);
...
Функция Получить_ОблагаемыеДоходы(Сотрудники)
...
Функция Получить_ВычетыЗаИсключениемСтандартных(Сотрудники)
...
Функция Получить_СтандартныеНалоговыеВычеты(Сотрудники)
