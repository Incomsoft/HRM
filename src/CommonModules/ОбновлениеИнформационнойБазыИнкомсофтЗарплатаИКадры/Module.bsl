...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	//	11.0.2.73:
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "11.0.2.73";
	Обработчик.Процедура           = "инкОбновлениеИнформационнойБазыСервер.Обновление_11_0_2_73";
	Обработчик.РежимВыполнения     = "Монопольно";
	Обработчик.НачальноеЗаполнение = Истина;       
	
	//	11.0.2.72:
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "11.0.2.72";
	Обработчик.Процедура           = "Справочники.инкДоходНДФЛ.Обновление_11_0_2_72";
	Обработчик.РежимВыполнения     = "Монопольно";
	Обработчик.НачальноеЗаполнение = Истина;       
...
Процедура ПриПодготовкеМакетаОписанияОбновлений(Макет) Экспорт
	...
	НомераВерсийДляОтображенияМассив.Добавить("11.0.2.73");
	НомераВерсийДляОтображенияМассив.Добавить("11.0.2.72");
